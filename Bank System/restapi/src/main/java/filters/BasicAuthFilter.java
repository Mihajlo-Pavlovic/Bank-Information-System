...
public class BasicAuthFilter implements ContainerRequestFilter {
    ...
    public void filter(ContainerRequestContext requestContext) throws IOException {
        ...
        if (authHeaderValues != null && authHeaderValues.size() > 0) {
            ...
            if (role.getRole().equals("privileged") && !endpointName.equals("users") && !endpointName.equals("roles")) {
                return;
            }
            if (role.getRole().equals("unprivileged") && (!endpointName.equals("users") || (endpointName.equals("users") && pathSegment1 != null && pathSegment1.equals("myinfo"))) && !endpointName.equals("roles") && "GET".equals(method)) {
                return;
            }
